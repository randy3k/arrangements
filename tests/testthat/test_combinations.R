...
test_that("Combinations - ncombinations", {
    ...
    expect_equal(ncombinations(x = L[1:10], r = 3), 120)
    expect_error(ncombinations(40, 15), "integer overflow")
    expect_error(ncombinations(x = L[1:40], r = 15), "integer overflow")
    ...
    expect_error(ncombinations(10, -1), "non-negative")
    expect_error(ncombinations(10, 1.5), "non-negative")
...
test_that("Combinations - combinations", {
    ...
    comb <- combinations(x = LETTERS[1:10], r = 3)
    expect_equal(nrow(comb), 120)
    expect_equal(ncol(comb), 3)
    expect_equal(comb[1, ], LETTERS[1:3])
    expect_equal(comb[120, ], LETTERS[8:10])

    expect_error(combinations(10, -1), "non-negative")
    expect_error(combinations(10, 1.5), "non-negative")
    expect_equal(dim(combinations(10, 0)), c(0, 0))
    expect_equal(dim(combinations(10, 11)), c(0, 11))
    expect_equal(dim(combinations(0, 0)), c(0, 0))
...
test_that("Combinations - icombinations", {
    ...
    expect_equal(icomb$getnext(type = "c"), 1:3)
    expect_equal(icomb$getnext(type = "c"), c(1, 2, 4))
    ...
    expect_equal(icomb$getnext(type = "l"), 1:3)
    expect_equal(icomb$getnext(type = "l"), c(1, 2, 4))
    ...
    expect_equal(icomb$collect(), NULL)
    expect_equal(icomb$getnext(), NULL)
    expect_error(icombinations(10, -1), "non-negative")
    expect_error(icombinations(10, 1.5), "non-negative")
})
