...
test_that("combinations with replacement - ncombinations", {
    ...
    expect_equal(ncombinations(x = LETTERS[1:8], r = 3, replace = TRUE), 120)
    expect_error(ncombinations(40, 10, replace = TRUE), "integer overflow")
    expect_error(ncombinations(x = L[1:40], r = 10, replace = TRUE), "integer overflow")
    ...
    # expect_error(ncombinations(6, -1, replace = TRUE), "non-negative")
    # expect_error(ncombinations(6, 1.5, replace = TRUE), "non-negative")
...
test_that("Combinations with replacement - combinations", {
    ...
    comb <- combinations(x = LETTERS[1:8], r = 3, replace= TRUE)
    expect_equal(nrow(comb), 120)
    expect_equal(ncol(comb), 3)
    expect_equal(comb[1, ], LETTERS[rep(1, 3)])
    expect_equal(comb[120, ], LETTERS[rep(8, 3)])

    # expect_error(combinations(5, -1, replace= TRUE), "non-negative")
    # expect_error(combinations(5, 1.5, replace= TRUE), "non-negative")
...
test_that("Combinations with replacement - icombinations", {
    ...
    expect_equal(icomb$getnext(type = "c"), rep(1, 3))
    expect_equal(icomb$getnext(type = "c"), c(1, 1, 2))
    ...
    expect_equal(icomb$getnext(type = "l"), rep(1, 3))
    expect_equal(icomb$getnext(type = "l"), c(1, 1, 2))
    ...
    # expect_error(icombinations(5, -1, replace= TRUE), "non-negative")
    # expect_error(icombinations(5, 1.5, replace= TRUE), "non-negative")
})
