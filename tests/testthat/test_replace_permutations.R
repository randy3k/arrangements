...
test_that("Permutations with replacement - npermutations", {
    ...
    expect_equal(npermutations(x = LETTERS[1:5], r = 3, replace = TRUE), 125)
    expect_error(npermutations(10, 10, replace = TRUE), "integer overflow")
    expect_error(npermutations(x = LETTERS[1:10], r = 10, replace = TRUE), "integer overflow")
    ...
    expect_error(npermutations(6, -1, replace = TRUE), "non-negative")
    expect_error(npermutations(6, 1.5, replace = TRUE), "non-negative")
...
test_that("Permutations with replacement - permutations", {
    ...
    perm <- permutations(x = LETTERS[1:5], r = 3, replace= TRUE)
    expect_equal(nrow(perm), 125)
    expect_equal(ncol(perm), 3)
    expect_equal(perm[1, ], LETTERS[rep(1, 3)])
    expect_equal(perm[125, ], LETTERS[rep(5, 3)])

    expect_error(permutations(5, -1, replace= TRUE), "non-negative")
    expect_error(permutations(5, 1.5, replace= TRUE), "non-negative")
    expect_equal(dim(permutations(5, 0, replace= TRUE)), c(0, 0))
    expect_equal(dim(permutations(2, 3, replace= TRUE)), c(8, 3))
    expect_equal(dim(permutations(0, 0, replace= TRUE)), c(0, 0))
...
test_that("Permutations with replacement - ipermutations", {
    ...
    expect_equal(iperm$getnext(type = "c"), rep(1, 3))
    expect_equal(iperm$getnext(type = "c"), c(1, 1, 2))
    ...
    expect_equal(iperm$getnext(type = "l"), rep(1, 3))
    expect_equal(iperm$getnext(type = "l"), c(1, 1, 2))
    ...
    expect_error(ipermutations(5, -1, replace= TRUE), "non-negative")
    expect_error(ipermutations(5, 1.5, replace= TRUE), "non-negative")
})
