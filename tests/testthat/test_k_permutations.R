...
test_that("K-Permutations - npermutations", {
    ...
    expect_error(npermutations(6, -1), "positive integer")
    expect_error(npermutations(6, 1.5), "positive integer")
...
test_that("K-Permutations - permutations", {
    ...
    expect_error(permutations(6, -1), "positive integer")
    expect_error(permutations(6, 1.5), "positive integer")
