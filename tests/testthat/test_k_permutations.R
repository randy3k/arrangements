...
test_that("K-Permutations - npermutations", {
    ...
    expect_equal(npermutations(x = LETTERS[1:6], r = 3), 120)
    expect_error(npermutations(14, 10), "integer overflow")
    expect_error(npermutations(x = LETTERS[1:14], r = 10), "integer overflow")
...
test_that("K-Permutations - permutations", {
    ...
    perm <- permutations(x = LETTERS[1:6], r = 3)
    expect_equal(nrow(perm), 120)
    expect_equal(ncol(perm), 3)
    ...
    expect_equal(dim(permutations(6, 0)), c(0, 0))
    expect_equal(dim(permutations(6, 7)), c(0, 7))
    expect_equal(dim(permutations(0, 0)), c(0, 0))
...
test_that("Multiset K-Permutations - npermutations", {
    expect_equal(npermutations(f = c(3, 2, 3), r = 4), 70)
    expect_equal(npermutations(x = LETTERS[1:3], f = c(3, 2, 3), r = 4), 70)
    expect_error(npermutations(f = c(10, 50, 10), r = 20), "integer overflow")
    expect_error(npermutations(x = LETTERS[1:3], f = c(10, 50, 10), r = 20), "integer overflow")
...
test_that("Multiset K-Permutations - permutations", {
    ...
    expect_equal(dim(permutations(f = c(3, 2, 3), r = 0)), c(0, 0))
    expect_equal(dim(permutations(f = c(0, 0, 0), r = 1 )), c(0, 1))
    expect_equal(dim(permutations(f = c(0, 0, 0), r = 0 )), c(0, 0))
})

test_that("Multiset K-Permutations - ipermutations", {
    iperm <- ipermutations(f = c(3, 2, 3), r = 4)
    perm <- permutations(f = c(3, 2, 3), r = 4)
    expect_equal(iperm$collect(), perm)
    ...
    expect_equal(iperm$collect(), NULL)
    expect_equal(iperm$getnext(), NULL)
    iperm <- ipermutations(f = c(3, 2, 3), r = 9)
    expect_equal(iperm$collect(), NULL)
    expect_equal(iperm$getnext(), NULL)
})
